...
I am deeply passionate about analyzing different data types, uncovering insights, and presenting them through beautiful visuals.
...
This portfolio showcases my data analysis and visualization skills using SQL, Power BI, Excel, and R. The projects cover a wide range of topics, including sales analysis, customer satisfaction, retail performance, and forecasting and quantitative analysis.
...
- **Customer Satisfaction.pbix**: Analyzes customer satisfaction metrics, including feedback scores, customer retention rates, and satisfaction trends over time.
The main goal of `Customer Satisfaction.pbix` is to uncover customer waiting time, dining purpose, dining frequency and loyalty members using `COUNTROWS` and visualize 9 interactive charts to keep track customer satisfaction and rating at a restaurant.

- **Ecommerce Sales Analysis.pbix**: Provides insights into e-commerce sales performance, such as website traffic, conversion rates, average order value, and cart abandonment rates.
Build 1 interactive dashboard to visualize Ecommerce sales, payment method

- **Retail Analysis.pbix**: Examines retail sales data and trends, highlighting key performance indicators like same-store sales growth, inventory turnover, and regional sales comparisons.
Executed DAX `SUM`, `DISTINCTCOUNT`, `DIVIDE`, `COUNTA` to measure retail data
Built 3 interactive Power BI dashboards to visualize and track store sales, district monthly sales and new store analysis
...
- Performed deep dive analysis using regression macro-based model to explore the variables’ impact on
changes in PHP/USD, VND/USD and predicted currencies pair using `FORECAST.ETS`
- Calculated WACC, NPV, IRR to measure project’s financial value, purchased forward contracts to mitigate
...
- Developed assumptions to predict +33 statistics types, conducted calculations for CAPM and DCF-FCFE Model, visualized 37 graphs and 12 tables using Excel
...
- **ARIMA Modeling and Forecasting:**
  ...
  - Selected the optimal model based on AICc and BIC criteria.
...
- **Data Visualization and Decomposition:**
  ...
  - Performed Seasonal-Trend Decomposition using LOESS (STL) to separate the series into trend, seasonal, and residual components.
...
- **Forecasting Future Prices:**
  ...
  - Extended the forecast to 24 months to predict prices for the year 2024.

- **Residual Analysis:**
  - Performed residual diagnostics on all fitted models to assess their adequacy.
  - Used residual plots to check for patterns, ensuring randomness and absence of autocorrelation.
  - Conducted the Shapiro-Wilk test on residuals to assess normality.
  - Confirmed that the ETS(AAN) model residuals behaved like white noise, indicating a good fit.

- **Key Achievements:**
  - Successfully cleaned and prepared a complex time series dataset with outliers.
  - Identified the most accurate forecasting model for aluminum spot prices.
  - Provided actionable forecasts that can inform investment and trading decisions in the metals market.
